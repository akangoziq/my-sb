...
cl = LineClient("khoirurozikin6@gmail.com","kangoziq7")
...
poll = LinePoll(cl)
call = cl
creator = ["ub58eea15bc620c51a7e35c97f8c36f3a"]
owner = ["ub58eea15bc620c51a7e35c97f8c36f3a"]
admin = ["ub58eea15bc620c51a7e35c97f8c36f3a"]
staff = ["ub58eea15bc620c51a7e35c97f8c36f3a"]
                            ...
                            if msg._from in admin:
                                try:
                                    ...
                                    if type(query) == int:
                                        ...
                                        cl.sendT,ext(receiver, 'gunakan key sticker angka bukan huruf')
                                except Exception as e:
                                    cl.sendText(receiver, str(e))
...
#===========BOT UPDATE============#
                        elif msg.text in ["Cipok","Tagall","Desah","Emuach","Assalamualaikum","Pagi","Siang","Sore","Malam","yank","All"]:
                               if wait["selfbot"] == True:
                                if msg._from in admin:
...
#===========Hiburan============#
                          ...
                          if wait["selfbot"] == True:
                           if msg._from in admin:
                              korban = msg.text.replace('Spam:@','2')
                              korban2 = korban.split()
                              midd = korban2[0]
                              jumlah = int(korban2[1])
                              if jumlah <= 1000:
...
"MEMBAWA PERDAMAIAN"
 "MENJAGA KERUKUNAN"
 "SELALU BERUSAHA"
 "TUK GUYUB RUKUN SEBISANYA"
 "SALAM SATU HATI"
 "SATU JIWA"
 "DALAM RUMAH SEDERHANA INI"
 "DARI SAYA"
 " http//line.me/p/~kangoziq"
